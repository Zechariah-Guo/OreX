...
- [ ] 1. Database schema and configuration
  - [ ] 1.1 Create `short_positions` table in `src/schema.sql` and write migration
  ...
  - [ ] 1.2 Add shorting configuration constants to `src/app/config.py`
  ...
  - [ ] 1.3 Add new transaction types to the existing transaction system
...
- [ ] 2. Implement core shorting engine calculations (`src/app/market/shorting.py`)
  - [ ] 2.1 Create `src/app/market/shorting.py` with collateral calculation functions
  ...
  - [ ] 2.2 Add tick fee calculation function to `src/app/market/shorting.py`
  ...
  - [ ] 2.3 Add squeeze price estimation function to `src/app/market/shorting.py`
  ...
  - [ ] 2.4 Add shared position close logic to `src/app/market/shorting.py`
  ...
  - [ ]* 2.5 Write property test for collateral calculation pipeline
  ...
  - [ ]* 2.6 Write property test for tick fee calculation
  ...
  - [ ]* 2.7 Write property test for voluntary close settlement
...
- [ ] 3. Implement tick-phase processing functions in `src/app/market/shorting.py`
  - [ ] 3.1 Implement Phase 1: SL/TP evaluation (`_evaluate_sltp_triggers`)
  ...
  - [ ] 3.2 Implement Phase 2: Margin call rebalancing (`_rebalance_margin`)
  ...
  - [ ] 3.3 Implement Phase 3: Time-bleed fee deduction (`_apply_time_bleed_fees`)
  ...
  - [ ] 3.4 Implement Phase 4: Forced liquidation check (`_check_forced_liquidation`)
  ...
  - [ ] 3.5 Implement main entry point `process_short_positions(db)`
  ...
  - [ ]* 3.6 Write property test for collateral rebalancing conservation of money
  ...
  - [ ]* 3.7 Write property test for margin call liquidation trigger
  ...
  - [ ]* 3.8 Write property test for margin call processing order
  ...
  - [ ]* 3.9 Write property test for fee processing order and exhaustion
  ...
  - [ ]* 3.10 Write property test for no negative FreeCash after forced liquidation
  ...
  - [ ]* 3.11 Write property test for forced liquidation mechanics
  ...
  - [ ]* 3.12 Write property test for SL/TP trigger execution
  ...
  - [ ]* 3.13 Write property test for SL/TP priority over forced liquidation
...
- [ ] 4. Checkpoint - Core engine verification
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Integrate shorting engine into tick loop and add trade routes
  - [ ] 5.1 Integrate `process_short_positions` into `src/app/market/engine.py`
  ...
  - [ ] 5.2 Add short order validation and open route to `src/app/routes/trade.py`
  ...
  - [ ] 5.3 Add short preview route to `src/app/routes/trade.py`
  ...
  - [ ] 5.4 Add voluntary close route to `src/app/routes/trade.py`
  ...
  - [ ] 5.5 Add SL/TP edit route to `src/app/routes/trade.py`
  ...
  - [ ]* 5.6 Write property test for order rejection when FreeCash insufficient
  ...
  - [ ]* 5.7 Write property test for balance deduction on valid short open
  ...
  - [ ]* 5.8 Write property test for SL/TP validation
  ...
  - [ ]* 5.9 Write property test for market influence registration
...
- [ ] 6. Checkpoint - Trade routes and tick integration
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Implement net worth update and bot shorting extension
  - [ ] 7.1 Update net worth calculation in `src/app/models.py`
  ...
  - [ ] 7.2 Extend bot trading in `src/app/market/bots.py` with shorting logic
  ...
  - [ ]* 7.3 Write property test for net worth formula with shorts
  ...
  - [ ]* 7.4 Write property test for bot short decision constraints
  ...
  - [ ]* 7.5 Write property test for bot short safety invariants
    - **Property 18: Bot Short Safety Invariants**
    - Test that bot SL = entry_price × 1.05 and total short capital <= 30% of bot balance
    - **Validates: Requirements 13.6, 13.7**

- [ ] 8. Implement dashboard and UI extensions
  - [ ] 8.1 Add short position dashboard data to `src/app/routes/dashboard.py`
  ...
  - [ ] 8.2 Create short order form template (htmx partial)
  ...
  - [ ] 8.3 Create short position cards template for dashboard
  ...
  - [ ] 8.4 Add Squeeze Zone line to ore price chart
  ...
  - [ ] 8.5 Update leaderboard to use updated net worth formula
...
- [ ] 9. Implement account reset and delete handling
  - [ ] 9.1 Extend account reset logic to clean up short positions
  ...
  - [ ] 9.2 Extend account delete logic to remove short positions
  ...
  - [ ]* 9.3 Write property test for account reset cleans all short state
...
- [ ] 10. Integration tests and final checkpoint
  - [ ]* 10.1 Write integration tests for full short lifecycle
  ...
  - [ ]* 10.2 Write integration tests for bot shorting
  ...
  - [ ]* 10.3 Write integration tests for net worth and account reset
